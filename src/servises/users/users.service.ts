...
export class UsersService {
  ...
  public searchUsers(query: string): Observable<TSearchedUser[]> {
    return this.httpService
      .get(`https://imai.co/api/dict/users/`, {
        headers: {
  ...
  public getUserFeeds(username: string): Observable<TUserDetails["feeds"]> {
    return this.httpService
      .get(`https://imai.co/api/raw/ig/user/feed/`, {
        headers: {
          authkey: this.authKey,
        },
        params: {
  ...
  public getUserInfo(username: string): Observable<TUserDetails> {
    return this.httpService
      .get(`https://imai.co/api/exports/contacts/`, {
        headers: {
          authkey: this.authKey,
        },
        params: {
